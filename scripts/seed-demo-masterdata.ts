...
const PERSONNEL: PersonnelRole[] = [
  ...
  personnelRole({
    ...
    gueltigVon: "2025-01-01",
    gueltigBis: null,
    notes: "Lieferanten VN/CN, Preisverhandlung, QC",
  }),
  personnelRole({
  ...
  personnelRole({
    ...
    headcount: 2,
    hiresPerPeriod: 1,
    hireFrequency: "semiannual",
    maxHeadcount: 6,
    waehrung: "EUR",
    kategorie: "vertriebsgemeinkosten",
    verteilschluessel: "nach_umsatzanteil",
    manuelleAufteilung: null,
    dependencies: personnelDeps("pdep_demo_sales"),
    gueltigVon: "2025-01-01",
    gueltigBis: null,
    notes: "Angebote, Auftragsabwicklung, Händler-Support",
  }),
  personnelRole({
  ...
  personnelRole({
    ...
    verteilschluessel: "nach_umsatzanteil",
    manuelleAufteilung: null,
    dependencies: personnelDeps("pdep_demo_mkt_perf"),
    gueltigVon: "2025-06-01",
    gueltigBis: null,
    notes: "SEA/Social Ads für Saison- und Bike-Sortiment",
  }),
  personnelRole({
    id: "prs_demo_cs",
    ...
    verteilschluessel: "nach_umsatzanteil",
    manuelleAufteilung: null,
    dependencies: personnelDeps("pdep_demo_cs"),
    gueltigVon: "2025-04-01",
    gueltigBis: null,
    notes: "Reklamationen, Nachbestellungen, Händler-Onboarding",
  }),
  personnelRole({
